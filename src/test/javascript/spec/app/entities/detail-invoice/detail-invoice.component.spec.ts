...
import { DetailInvoiceComponent } from 'app/entities/detail-invoice/detail-invoice.component';
...
describe('Component Tests', () => {
  describe('DetailInvoice Management Component', () => {
    let comp: DetailInvoiceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DetailInvoiceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.detailInvoices && comp.detailInvoices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
